...
export interface InitOutput {
  ...
  readonly closure1045_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1321_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3619_externref_shim: (a: number, b: number, c: any, d: any) => void;
